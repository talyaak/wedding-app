...
const Hero = () => {
    return (
        <section id="home" className={`flex md:flex-row flex-col py-2 h-full`}>
            <div className={`flex-1 ${styles.flexCenter} flex-col xl:px-0 sm:px-16 xs:mt-20 xs:mb-10 md:mt-0 md:mb-0 px-6 lg:mr-28`}>
            ...
            <div className={`flex-1 flex ${styles.flexCenter}`}>
                <div className='bg-[#F1EBE5]/75 border-2 border-[#000000]/25 md:h-[60%] h-[450px] w-[80%] rounded-sm md:my-0 my-2 md:mr-28'>
